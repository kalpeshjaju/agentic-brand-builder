...
program
  ...
  .action(async (options) => {
    try {
      ...
      // Beta Status
      console.log(chalk.bold.yellow('⚠️  BETA - 50% Complete (20 of 40 agents implemented)'));
      console.log(chalk.yellow('   Remaining agents return placeholder data. See README.md for details.\n'));
